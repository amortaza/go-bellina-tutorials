...
#### Tutorial 1: Simplest Bellina application

This is the simplest possible Bellina application.

> [Github: Tutorial 1](https://github.com/amortaza/go-bellina-tutorials/tutorial_01)
...
The first parameter is an implementation of the `bl.HAL` interface which is what feeds Bellina the keyboard / mouse events and also provides a graphics object which allows rendering.

Here we use a reference implementation called `amortaza/hal_g5`

We set the application window to dimension 1280 x 1024.

The title reads "Bellina v0.9".

Next we pass in a callback function called `initialize`
